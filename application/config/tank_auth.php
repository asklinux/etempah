<?php if ( ! defined('BASEPATH') && ! defined('INSTALLATION_BASEPATH')) exit('No direct script access allowed tank_auth');
...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Sistem eTempah';
$config['webmaster_email'] = 'systemdosh@mohr.gov.my';
...
$config['email_activation_expire'] = 60*60*24*2; // 2 days
...
$config['autologin_cookie_life'] = 60*60*24*31*2; // 2 months
...
|--------------------------------------------------------------------------
*/
$config['forgot_password_expire'] = 60*15; // 15 minutes
