<?php  if ( ! defined('BASEPATH') && ! defined('INSTALLATION_BASEPATH')) exit('No direct script access allowed config');

$config['admin_email']  = 'systemdosh@mohr.gov.my';
$config['pagination_per_page']  = '10';
$config['website_name'] = 'eTempah';
/*
|--------------------------------------------------------------------------
| Base Site URL
|--------------------------------------------------------------------------
...
|
*/
$config['encryption_key'] = 'ro4SIHqqd#Y.m0Q%hM+MlfRfZ@cF8ZJB';
