...
(function($) {
		...
		init: function(options) {
			return this.each(function() {
		        ...
		        if (opt.validate) {
					...
					$(opt.displayErrorTo).append('<div class="stepy-error span10 offset1"/>');
		        }
		        ...
		        $steps.each(function(index) {
		        	...
		        	.append('<div class="row-fluid"><div id="' + id + '-buttons-' + index + '" class="' + id + '-buttons span10 offset1"/></div>');
				...
				if (opt.finishButton) {
					...
					$finish.appendTo($this.find('div#custom-buttons-4:last'));
			        } else {
        	...
        	$('<a/>', { id: id + '-back-' + index, href: 'javascript:void(0);', 'class': 'button-back btn', html: opt.backLabel }).click(function() {
        	...
        	$('<a/>', { id: id + '-next-' + index, href: 'javascript:void(0);', 'class': 'button-next btn', html: opt.nextLabel }).click(function() {
	...
	$.fn.stepy.defaults = {
		...
		validate:		false,
		select: 		undefined,
		displayErrorTo: '.error-container'
	};
